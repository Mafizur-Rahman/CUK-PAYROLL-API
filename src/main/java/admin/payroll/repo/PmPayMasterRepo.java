...
public interface PmPayMasterRepo extends JpaRepository<PmPayMasteEntity, String> {
	...
	@Modifying
	@Transactional
	@Query(value = "delete from PmPayMasteEntity e where e.empNo=:empNo  AND e.earningdeduction=:earningdeductionn AND e.payperiod=:payperiod")
	int deletePmPayMaster(String empNo, String earningdeduction, String payperiod);
