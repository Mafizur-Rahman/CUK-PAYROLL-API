...
public class UserExcelExporter {
	...
	private List<PmUsersEntity> listUsers;

	public UserExcelExporter(List<PmUsersEntity> listUsers) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 1, "USERTYPE", style);
		createCell(row, 2, "EMAILID", style);
	...
	private void writeDataLines() {
		...
		for (PmUsersEntity user : listUsers) {
