...
public class SSLicExcelExporter {
	private XSSFWorkbook workbook;
	private XSSFSheet sheet;
	private List<PaybillAndOtherEntity> listUsers;

	public SSLicExcelExporter(List<PaybillAndOtherEntity> listUsers) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 2, "EmpId", style);
		createCell(row, 3, "PolicyNo", style);
