...
public class LPWCExcelExporter {
	private XSSFWorkbook workbook;
	private XSSFSheet sheet;
	private List<PaybillEntity> listUsers;

	public LPWCExcelExporter(List<PaybillEntity> listUsers) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 2, "QTR NO", style);
		createCell(row, 3, "Light", style);
		createCell(row, 4, "Power", style);
		createCell(row, 5, "Water", style);
	}
