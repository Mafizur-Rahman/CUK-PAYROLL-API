...
public class GisExcelExporter {
	private XSSFWorkbook workbook;
	private XSSFSheet sheet;
	private List<PaybillAndOtherEntity> listUsers;

	public GisExcelExporter(List<PaybillAndOtherEntity> listUsers) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 3, "GPF A/C No", style);
		createCell(row, 4, "Basic Pay", style);
